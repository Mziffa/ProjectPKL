<?php
	...
	$show = mysql_query("SELECT * FROM barang WHERE kode='$id'");
...
"></td> <!-- value diambil dari hasil query -->	
			...
			<tr>
				<td>tanggal_masuk</td>
				<td><input type="date" name="tanggal_masuk" size="30" value="<?php echo $data['tanggal_masuk']; ?>" required="" style="
    height: 30px;
"></td> <!-- value diambil dari hasil query -->	
			</tr>
			<tr>
                <td>tanggal_keluar</td>
				<td><input type="date" name="tanggal_keluar" size="30" value="<?php echo $data['tanggal_keluar']; ?>" required="" style="    		
	height: 30px;
				">
